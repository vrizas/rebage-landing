    ...
    return (
        <footer className="flex gap-8 flex-col text-center px-4 pt-10 bg-gradient-to-r from-[#DCFAE5] to-[#EAF5ED] lg:text-left lg:flex-row items-center lg:justify-between lg:px-14">
            ...
            <div className="text-dark-gray">
                ...
                <div className="mt-3 flex flex-col gap-2 font-[600] items-center lg:items-start">
                    <a href="https://www.instagram.com/rebage.id/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
